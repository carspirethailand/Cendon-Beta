...
export const QUIZ = [
  {
    q: "ไฟเตือนรูปเครื่องยนต์สีส้มบนหน้าปัด ควรทำอะไร?",
    o: ["ขับต่อได้ปกติ ไม่ต้องสน", "รีบตรวจ/สแกน OBD", "เติมน้ำมันให้เต็มถัง"],
    a: 1,
    e: "ไฟเช็กเครื่องยนต์ = ระบบพบความผิดปกติ ควรสแกนหาสาเหตุ"
  },
  {
    q: "ปกติควรเปลี่ยนน้ำมันเครื่องทุกๆ ประมาณกี่กิโลเมตร?",
    o: ["1,000 กม.", "~10,000 กม. (หรือ 6 เดือน)", "100,000 กม."],
    a: 1,
    e: "รถส่วนใหญ่ ~10,000 กม. หรือ 6 เดือน แล้วแต่ถึงก่อน"
  },
  {
    q: "เสียง 'เอี๊ยด' ตอนเหยียบเบรก มักหมายถึงอะไร?",
    o: ["ผ้าเบรกใกล้หมด", "น้ำมันเต็มถัง", "ยางลมเยอะไป"],
    a: 0,
    e: "เสียงเอี๊ยดตอนเบรกมักเป็นสัญญาณผ้าเบรกสึก"
  },
  {
    q: "ลมยางอ่อนเกินไป ส่งผลยังไง?",
    o: ["ประหยัดน้ำมันขึ้น", "กินน้ำมันขึ้น + ยางสึกเร็ว", "ไม่มีผลอะไร"],
    a: 1,
    e: "ลมอ่อนทำให้แรงต้านมากขึ้น กินน้ำมันและยางสึกไม่สม่ำเสมอ"
  }
];
